...
class TestProductionInvokerRegistry:
    ...
    def test_every_invoker_is_scheduled_or_on_demand(self) -> None:
        ...
        expected_on_demand = {
            ...
            # #1233 PR-1b / #740 — cusip_resolver_post_bulk_sweep moved
            # OUT of this on-demand cohort: it now carries a weekly
            # scheduled cadence (Sun 06:00 UTC, ``openfigi`` lane) in
            # addition to its bootstrap S13 dispatch.
