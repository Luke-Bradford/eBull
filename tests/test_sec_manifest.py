    ...
    def test_insider_upsert_bumps_ingested_at(
        ...
        def _record() -> None:
            record_insider_observation(
                ...
                source_accession="0001234500-25-000501",
                source_field=None,
                source_url=None,
                filed_at=datetime(2026, 1, 1, tzinfo=UTC),
                period_start=None,
    ...
    def test_institution_upsert_bumps_ingested_at(
        ...
        def _record() -> None:
            record_institution_observation(
                ...
                source_accession="0001234500-25-000502",
                source_field=None,
                source_url=None,
                filed_at=datetime(2026, 2, 14, tzinfo=UTC),
                period_start=None,
    ...
    def test_blockholder_upsert_bumps_ingested_at(
        ...
        def _record() -> None:
            record_blockholder_observation(
                ...
                source_accession="0001234500-25-000503",
                source_field=None,
                source_url=None,
    ...
    def test_treasury_upsert_bumps_ingested_at(
        ...
        def _record() -> None:
            record_treasury_observation(
                ...
                source_accession="0001234500-25-000504",
                source_field=None,
                source_url=None,
                filed_at=datetime(2026, 1, 1, tzinfo=UTC),
                period_start=None,
    ...
    def test_def14a_upsert_bumps_ingested_at(
        ...
        def _record() -> None:
            record_def14a_observation(
                ...
                source_accession="0001234500-25-000505",
                source_field=None,
                source_url=None,
