...
_INSERT_WITHOUT_BASIS = """
    INSERT INTO strategy_results_store (
        ...
        cost_model_id, carry_unmodelled, sizing_rule, benchmark_rule, ambiguity_rule_version,
        position_rule_set_version,
        ...
        %(cost_model_id)s, %(carry_unmodelled)s, %(sizing_rule)s, %(benchmark_rule)s,
        %(ambiguity_rule_version)s, %(position_rule_set_version)s,
