...
def native_amount(amount_usd: Decimal, open_conversion_rate: Decimal | None) -> Decimal | None:
    ...
    """
    if open_conversion_rate is None or not open_conversion_rate.is_finite() or open_conversion_rate <= 0:
        return None
