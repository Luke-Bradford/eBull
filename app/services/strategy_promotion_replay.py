...
REPLAY_TEMPORAL_POLICY: Final[Mapping[str, ReplayPolicyEntry]] = {
    "result": ReplayPolicyEntry(
        ...
        reason=(
            ...
            "§9 verdicts through synthetic_control_promotion_refusals (#2639); for a hold-out result, #2737 "
            "feeds that function the exact in-sample companion derived by strategy_result_control_support, "
            "because the withheld row deliberately owns no 1,000-look cohort. Every one of those functions "
