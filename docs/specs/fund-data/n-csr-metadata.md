...
> Predecessor: spike `docs/_archive/2026-05-14-n-csr-feasibility.md` (verdict scope = audit-attestation on holdings; THIS spec narrows that verdict and adds a distinct fund-metadata extraction lane).
...
7. **Documentation updates**:
   ...
   - Spike doc `docs/_archive/2026-05-14-n-csr-feasibility.md` — append §10.6 "Scope narrowing" + narrow §10.3 wording.
...
- **Spike**: `docs/_archive/2026-05-14-n-csr-feasibility.md` (#918 closeout).
...
3. Implementation plan doc (`docs/_archive/2026-05-14-n-csr-fund-metadata-plan.md`).
