...
- Spec for #575 (polish round 2): `docs/_archive/2026-04-27-instrument-detail-polish-round-2-design.md`
...
type: project
---
Work scope: redesign instrument-page charts to quant-grade analytical views with per-domain L2 drill pages. Spec at docs/_archive/2026-04-27-instrument-charts-quant-redesign-design.md.
