...
**Spec:** `docs/_archive/2026-04-27-instrument-detail-density-grid-design.md`
...
Phase 1 of the density-grid spec (`docs/_archive/2026-04-27-instrument-detail-density-grid-design.md`). Phase 2 needs structured tables to render in the 10-K drilldown.
