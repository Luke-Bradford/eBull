...
Three deliverables. Each follows the #1208-shape cadence: spike → spec → Codex 1a/1b → impl → Codex 2 → push → bot → merge. Spec docs live at `docs/_archive/2026-05-NN-<phase>-<short>.md`.
...
- **Spec gate:** `docs/_archive/2026-05-NN-1218-parser-period-end.md` + Codex 1a/1b.

### Phase A.2 — #1010 13F sweep cohort bound — CLOSED 2026-05-19

**Merged:** PR #1222 / `240112e`.
**Spec:** `docs/_archive/2026-05-19-1010-13f-cohort-bound.md`.
...
**Spec:** `docs/_archive/2026-05-19-1136-bootstrap-state-audit.md`.
...
2. Spike + spec doc at `docs/_archive/2026-05-NN-<phase>-<short>.md`.
...
```
Pick up Phase C of docs/_archive/2026-05-19-post-1208-cleardown.md
...
```
Pick up Phase A.1 of docs/_archive/2026-05-19-post-1208-cleardown.md
...
- Mirror #1208 cadence: spike → spec → Codex 1a/1b → impl → Codex 2
  → push → bot → merge.
- Spec at docs/_archive/2026-05-NN-1218-parser-period-end.md.
