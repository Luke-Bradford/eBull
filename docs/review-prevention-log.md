...
- Enforced in: this prevention log; `frontend/scripts/check-chart-integrity.mjs` (`RATCHET` + empty-ratchet guard + orphan-entry check); `.claude/skills/frontend/design-system.md` (Chart theming — ONE source).
