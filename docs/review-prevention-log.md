...
- Enforced in: this prevention log; `tests/fixtures/ebull_test_db.py::_PLANNER_TABLES` (now lists the `copy_*` mirror cluster + `cash_ledger` / `capital_events` / `report_snapshots`).
