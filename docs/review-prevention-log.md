...
- Enforced in: `app/workers/scheduler.py::ScheduledJob.exempt_from_universal_bootstrap_gate` field + `tests/test_universal_gate_carve_out.py` registry-invariant allow-list + spec `docs/superpowers/specs/2026-05-16-lane-b-discovery-firing.md` §4.2 + this prevention log.
...
- Enforced in: this prevention log; `app/services/postgres_health.py::collect_postgres_health` (opens own autocommit conn for 7 probes); `app/services/financial_facts_retention.py::sweep_retention_all_instruments` (orchestrator-of-N pattern); `tests/test_api_postgres_health.py::test_metric_isolation_returns_partial_payload` (regression). Spec `docs/superpowers/specs/2026-05-19-phase4-postgres-health.md` §4.2. Landed in #1208 Phase 4.
...
- Enforced in: `scripts/check_ownership_refresh_writer_pattern.sh` invariants D1 + D2; `docs/superpowers/specs/2026-05-21-pr12-ownership-current-writer-merge.md` §4.3 + §5; this prevention log.
