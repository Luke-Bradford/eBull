...
export function StrategiesPage() {
  ...
  return (
    <div className="space-y-6">
      {/* The page title moved to StrategiesHubPage (#2868), which owns the
          lens header for both presets. Only the lens-specific subtitle stays. */}
      <header>
        <p className="max-w-3xl text-sm text-slate-600 dark:text-slate-400">
          Candidate strategies and the evidence behind them. Capital, positions and P&L are on the
          Portfolio lens.
        </p>
      </header>
      {overview.loading ? (
