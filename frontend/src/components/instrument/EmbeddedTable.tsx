...
export function EmbeddedTable({ table }: EmbeddedTableProps): JSX.Element {
  return (
    <table className="my-4 w-full border-collapse text-sm">
      <thead>
        <tr className="border-b border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/40 text-left text-xs uppercase tracking-wider text-slate-600">
