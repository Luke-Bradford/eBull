        ...
        {isFunds
          ...
          : isProxy
            ...
            : isEsop
              ...
              : isRestated
                ? // #3189 findings 14 + 22. The previous wording asserted the LOSING
                  // direction (“that channel reported the larger figure … so it won the
                  // dedup”), which is false whenever the 13D/G figure is the one that
                  // won — 3,862 holders on the 2026-09-18 dev corpus — and it also
                  // asserted “>5%”, which neither helper filters on (a 13G can report a
                  // reduced position, and the same-accession collapse admits any
                  // positive magnitude). States the invariant instead of one direction
                  // of it: one owner is counted once, under their most-specific role.
