...
describe("Pane", () => {
  ...
  it("fillHeight=true applies h-full + flex-col classes so the pane stretches to its grid cell (#647)", () => {
    render(
    ...
    // Body wrapper must propagate the fill so the chart container can use h-full.
